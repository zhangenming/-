...
const PLATFORM_SHOP_OPTIONS = [
  ...
  { label: "拼多多-轻松财务", platform: "拼多多", shopName: "轻松财务" },
  { label: "拼多多-智算财务", platform: "拼多多", shopName: "智算财务" },
  { label: "拼多多-佳和财务", platform: "拼多多", shopName: "佳和财务" },
  { label: "拼多多-全账通", platform: "拼多多", shopName: "全账通" },
  { label: "拼多多-账易顺", platform: "拼多多", shopName: "账易顺" },
  { label: "中信银行", platform: "中信银行", shopName: "中信银行", source: "其他" },
...
function getMonthlySettlementTableDisplay(record) {
  ...
  if (!display) return "";
  if (isAccountantLogin()) return display;
